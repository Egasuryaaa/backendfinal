        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('appointments.history') ? 'active' : '' }}" href="{{ route('appointments.history') }}">Janji Temu</a>
                    </li>
                </ul>
                    ...
                    @else
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <li><a class="dropdown-item" href="{{ route('appointments.history') }}"><i class="fas fa-calendar-check me-2"></i>Janji Temu</a></li>
