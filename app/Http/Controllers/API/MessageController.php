...
class MessageController extends Controller
{
    ...
    public function sendMessage(Request $request): JsonResponse
    {
        ...
        $messageData['time'] = Carbon::parse($message->created_at)->format('H:i');
        $messageData['date'] = Carbon::parse($message->created_at)->format('d M Y');
        
        // Pastikan lampiran_urls adalah array
        $messageData['lampiran_urls'] = [];
        if ($message->lampiran) {
            foreach ($message->lampiran as $attachment) {
                $messageData['lampiran_urls'][] = asset('storage/' . $attachment);
            }
        }
